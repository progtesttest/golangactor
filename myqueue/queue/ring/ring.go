...
var (
	...
	// queue.
	ErrDisposed = fmt.Errorf("queue: disposed")  //errors.New(`queue: disposed`)

	// ErrTimeout is returned when an applicable queue operation times out.
	ErrTimeout = fmt.Errorf("queue: poll timed out")  //errors.New(`queue: poll timed out`)

	// ErrEmptyQueue is returned when an non-applicable queue operation was called
	// due to the queue's empty item state
	ErrEmptyQueue = fmt.Errorf("queue: empty queue") //errors.New(`queue: empty queue`)
)
